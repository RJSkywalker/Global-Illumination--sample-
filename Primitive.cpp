...
void CSphere::SetKt(GzColor refractance)
{
	memcpy(&Kt, &refractance, sizeof(GzColor));
}
...
void CPlane::SetKt(GzColor refractance)
{
	memcpy(&Kt, &refractance, sizeof(GzColor));
}
...
void CTriangle::SetKt(GzColor refractance)
{
	memcpy(&Kt, &refractance, sizeof(GzColor));
}
